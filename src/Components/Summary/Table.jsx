            ...
            <TableBody>
              {rows.map((row, key) => (
                <TableRow key={key}>
                  ...
                  {row.col1 !== undefined ? <TableCell align="center">{row.col1}</TableCell> : null}
                  {row.col2 !== undefined ? <TableCell align="center">{row.col2}</TableCell> : null}
                  {row.col3 !== undefined ? <TableCell align="center">{row.col3}</TableCell> : null}
                  {row.col4 !== undefined ? <TableCell align="center">{row.col4}</TableCell> : null}
                  {row.col5 !== undefined ? <TableCell align="center">{row.col5}</TableCell> : null}
                  {row.col6 !== undefined ? <TableCell align="center">{row.col6}</TableCell> : null}
                </TableRow>
              ))}
            </TableBody>
          </Table>
